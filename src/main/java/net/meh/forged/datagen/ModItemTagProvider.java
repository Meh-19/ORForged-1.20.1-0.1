...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registryWrapper) {
        ...
        getOrCreateTagBuilder(ItemTags.PLANKS)
                ...
                .add(ModBlocks.OAK_PAPER_LANTERN.asItem())
                .add(ModBlocks.SPRUCE_PAPER_LANTERN.asItem())
                .add(ModBlocks.BIRCH_PAPER_LANTERN.asItem())
                .add(ModBlocks.JUNGLE_PAPER_LANTERN.asItem())
                .add(ModBlocks.ACACIA_PAPER_LANTERN.asItem())
                .add(ModBlocks.DARK_OAK_PAPER_LANTERN.asItem())
                .add(ModBlocks.MANGROVE_PAPER_LANTERN.asItem())
                .add(ModBlocks.CHERRY_PAPER_LANTERN.asItem())
                .add(ModBlocks.CRIMSON_SHROOM_LANTERN.asItem())
                .add(ModBlocks.WARPED_SHROOM_LANTERN.asItem())
                .add(ModBlocks.MAPLE_PAPER_LANTERN.asItem())
                .add(ModBlocks.BLEAK_PAPER_LANTERN.asItem())
                .add(ModBlocks.FIR_PAPER_LANTERN.asItem())
                .add(ModBlocks.PALM_PAPER_LANTERN.asItem())
                .add(ModBlocks.BAYOU_PAPER_LANTERN.asItem())
                .add(ModBlocks.WISTERIA_PAPER_LANTERN.asItem())
                .add(ModBlocks.BAOBAB_PAPER_LANTERN.asItem())
                .add(ModBlocks.BAMBOO_PAPER_LANTERN.asItem())
                .add(ModBlocks.FUNGAL_PAPER_LANTERN.asItem())

                .add(ModBlocks.OAK_PLANKS_CARVED.asItem())
                .add(ModBlocks.SPRUCE_PLANKS_CARVED.asItem())
                .add(ModBlocks.BIRCH_PLANKS_CARVED.asItem())
                .add(ModBlocks.JUNGLE_PLANKS_CARVED.asItem())
                .add(ModBlocks.ACACIA_PLANKS_CARVED.asItem())
                .add(ModBlocks.DARK_OAK_PLANKS_CARVED.asItem())
                .add(ModBlocks.MANGROVE_PLANKS_CARVED.asItem())
                .add(ModBlocks.CHERRY_PLANKS_CARVED.asItem())
                .add(ModBlocks.CRIMSON_PLANKS_CARVED.asItem())
                .add(ModBlocks.WARPED_PLANKS_CARVED.asItem())
